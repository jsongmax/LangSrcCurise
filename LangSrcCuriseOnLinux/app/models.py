...
class Setting(models.Model):
    ...
    Pool = models.CharField(max_length=4,default='2',  verbose_name='进程池量')
    processes = models.CharField(max_length=4,default='2',  verbose_name='进程数量')
    childconcurrency = models.CharField(max_length=4,default='2',  verbose_name='子协程数量')
    change_time = models.DateTimeField(auto_now=True,verbose_name='修改时间')
    class Meta:
        db_table = 'Setting'
        verbose_name = '配置信息'
