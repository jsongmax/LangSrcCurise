# Generated by Django 2.1.10 on 2019-08-15 12:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('counts', models.CharField(default=0, max_length=7, verbose_name='捕获数量')),
                ('change_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
            ],
            options={
                'verbose_name': '监控域名',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='None', max_length=120, verbose_name='网站标题')),
                ('power', models.CharField(default='None', max_length=50, verbose_name='容器/语言')),
                ('server', models.CharField(default='None', max_length=50, verbose_name='服务器类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Alive_Code', models.CharField(default='[200,301,302,401,402,500,503]', max_length=200, verbose_name='允许入库状态码')),
                ('Thread', models.CharField(default='2', max_length=4, verbose_name='线程数量')),
                ('Pool', models.CharField(default='2', max_length=4, verbose_name='进程池量')),
                ('processes', models.CharField(default='2', max_length=4, verbose_name='进程数量')),
                ('childconcurrency', models.CharField(default='2', max_length=4, verbose_name='子协程数量')),
                ('change_time', models.DateTimeField(auto_now=True, verbose_name='修改时间')),
            ],
            options={
                'verbose_name': '配置信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='None', max_length=100, verbose_name='网站标题')),
                ('power', models.CharField(default='None', max_length=50, verbose_name='容器/语言')),
                ('server', models.CharField(default='None', max_length=50, verbose_name='服务器类型')),
                ('status', models.CharField(default='None', max_length=4, verbose_name='请求响应')),
                ('ip', models.CharField(max_length=15, verbose_name='IP地址')),
                ...
                ('area', models.CharField(default='None', max_length=50, verbose_name='IP归属')),
